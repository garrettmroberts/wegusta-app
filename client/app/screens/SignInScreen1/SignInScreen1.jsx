        ...
        <SafeAreaView style={styles.safeAreaView}>
            ...
            >
                <Toast
                    ...
                    style={
                        state.isToastVisible ? styles.toast : styles.invisible
                    }
                ...
                <View style={styles.inputBlockWrapper}>
                    ...
                    <View>
                        <Text style={styles.termsAndConditions}>
                            By continuing you agree to Wegusta LLC’s Terms of
                            Use and confirm that you have read Wegusta LLC’s
                            Privacy Policy.
                        </Text>
                        <Button
                            type={
                                state.isButtonEnabled ? 'primary' : 'disabled'
                            }
                            size="fullWidth"
                            iconPlacement="none"
